...
#---------------------------------
''' Scale control  '''
LANDER_CONSTANT = 3  # Constant controlling the dimensions


# --------------------------------
"""Simulation Update"""
FPS = 60*(LANDER_CONSTANT/2)
UPDATE_TIME = 1/FPS

# --------------------------------
"""Simulation view, Scale and Math Conversions"""
# NOTE: Dimensions do not change linearly with Scale
SCALE = 30/LANDER_CONSTANT  # Adjusts Pixels to Units conversion, Forces, and Leg positioning. Keep at 30.
...
LEG_W, LEG_H = LANDER_LENGTH / 48 / LANDER_CONSTANT, LANDER_LENGTH / 6 / LANDER_CONSTANT
...
MASS = 25.222 / LANDER_CONSTANT
L1 = 3.8677 / LANDER_CONSTANT
L2 = 3.7 / LANDER_CONSTANT
LN = 0.1892 /LANDER_CONSTANT
INERTIA = 482.2956
GRAVITY = 9.81
